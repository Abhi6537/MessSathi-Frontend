...
export default function Hero() {
  ...
  return (
    <div className="relative pt-16 pb-8 overflow-hidden bg-transparent">
      {/* Background Image */}
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/register?type=tenant">
              <Button size="lg" className="font-medium bg-primary text-white hover:bg-primary/90">
                Find a Mess
            ...
            <Link to="/register?type=owner">
              <Button size="lg" variant="outline" className="font-medium border-gray-300 hover:bg-gray-800">
                List Your Mess
              </Button>
            </Link>
          </div>
          ...
          <div className="mt-12 flex justify-center">
            <div className="grid grid-cols-3 gap-6 sm:gap-12">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-400">Listed Messes</p>
              </div>
           ...
           {/* Wave divider with exact background color */}
           <div className="absolute bottom-[-90px] left-0 right-0">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full h-auto">
          <path
            fill="#020817" // <-- Change this color to match your next section
            fillOpacity="1"
