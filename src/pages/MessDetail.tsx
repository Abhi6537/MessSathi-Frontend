...
const messMockData = {
  ...
  phone: "+91 9876543210",
  email: "contact@sunshinevilla.com",
  images: [
    "https://images.unsplash.com/photo-1551927336-09d50efd69cd?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
  ...
  rooms: [
    { type: "Single", price: 8000, available: 2, total: 4 },
    { type: "Double", price: 6500, available: 1, total: 6 },
    { type: "Triple", price: 5500, available: 0, total: 2 },
  ],
  amenities: [
    "WiFi", "Hot Water", "Power Backup", "Security", 
    "Laundry", "TV Room", "Parking", "Air Conditioning"
  ],
  rules: [
